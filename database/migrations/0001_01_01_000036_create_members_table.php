...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('members', function (Blueprint $table) {
            ...
            $table->decimal('joining_fee', 8, 2)->default(0.00);
            $table->decimal('membership_fee', 8, 2)->default(0.00);
            $table->enum('membership_fee_frequency', ['monthly', 'quarterly', 'yearly'])->default('yearly');
            ...
            $table->softDeletes();
            $table->unique(['shelter_id', 'member_number']);
        });
    }
