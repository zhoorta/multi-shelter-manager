...
![Users list, admin view](screenshots/21-admin-users.png)

**As a manager**, you only see the users of your shelter:

![Users list, manager view](screenshots/53-users.png)
...
![Invite user, admin view](screenshots/22-admin-user-invite.png)

Manager view (the shelter is already set to the manager's shelter):

![Invite user, manager view](screenshots/54-user-invite.png)
