<div class="flex flex-col gap-8 text-neutral-700 dark:text-neutral-300">
    ...
    <section id="getting-started" class="flex scroll-mt-6 flex-col gap-2">
        ...
        <ol class="list-decimal space-y-1 ps-6">
            <li>Un amministratore crea il rifugio e compila le tabelle di riferimento (specie, razze, taglie, tipi di mantello, vaccini, malattie, attività).</li>
    ...
    <section id="pets" class="flex scroll-mt-6 flex-col gap-2">
        ...
        <p>Il menu Animali elenca gli animali del rifugio per specie. Ogni scheda include l'identificazione (riferimento, nome, microchip), la descrizione fisica (razza, colori, tipo di mantello, taglia, sesso, sterilizzazione), le date (nascita, ingresso, uscita, decesso), foto, una descrizione pubblica, note interne e note cliniche.</p>
    ...
    <section id="users" class="flex scroll-mt-6 flex-col gap-2">
        ...
        <p>Responsabili e amministratori invitano i nuovi utenti via email; la persona invitata riceve un link per impostare la propria password. Per ogni rifugio di appartenenza scegli il ruolo (responsabile o operatore) e se l'utente riceve le notifiche di vaccinazione.</p>
        <ul class="list-disc space-y-1 ps-6">
    ...
    <section id="administration" class="flex scroll-mt-6 flex-col gap-2">
        ...
        <ul class="list-disc space-y-1 ps-6">
            <li><strong>Rifugi</strong> &mdash; creare, modificare ed eliminare rifugi.</li>
